...
class latencyData:
    ...
    def __init__(self):
        ...
        # subscribers
        # self.laserscan_return = rospy.Subscriber("/scan", LaserScan, self.scan_return_callback)
    ...
    def laserscan_callback(self):
        ...
        msg_return = rospy.wait_for_message("/scan", LaserScan)

        header = msg_return.header.seq
        x = 1
        # print(x, sys.getsizeof(x))
        print(header, sys.getsizeof(header))
